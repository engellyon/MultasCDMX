<%-- 
    Document   : Registrar_NConductor
    Created on : 20-dic-2016, 22:24:26
    Author     : Spark
--%>
...
<html>
    <head>
        ...
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Registro de Nuevo Conductor</title>
    </head>
    <body>
        ...
        <div class="jumbotron">
            <div class="container" style="height:50px">
                <h1 align="center">Registro de Nuevo Conductor</h1>
            </div>
        </div>
        ...
        <div class="container col-md-11 col-md-offset-4">
            <form class="form-signin" action="Registrar_NConductor_Proceso.jsp" method="post" >
                <div class="col-xs-4">
                    ...
                    <input type="text" name="tipo" id="tipo" class="form-control" placeholder="A-B" required autofocus>                                        
